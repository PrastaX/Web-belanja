...
function checkout() {
    ...
    if (confirm(`Total belanja Anda ${formatCurrency(calculateTotal())}. Lanjutkan checkout?`)) {
...
document.querySelectorAll('.add-to-cart').forEach(button => {
    button.addEventListener('click', function () {
        ...
        const productPrice = parseFloat(productElement.querySelector('.product-price').textContent.replace(/[^0-9.-]+/g, '')); // Ambil harga produk
